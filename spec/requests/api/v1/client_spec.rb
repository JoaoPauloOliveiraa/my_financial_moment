...
RSpec.describe "Api::V1::Clients", type: :request do
  ...
  it 'should create a client with loan product EMPRESTIMO_PESSOAL' do
    ...
    post '/api/v1/clients', params: { client: { name: 'Joao', cpf: '12345678911', birth_date: '1990/03/17', uf: 'PR', income: '3000' } }
  ...
  it 'should create a client with loan product EMPRESTIMO_PESSOAL and EMPRESTIMO_CONSIGNADO' do
    ...
    post '/api/v1/clients', params: { client: { name: 'Joao', cpf: '12345678911', birth_date: '1990/03/17', uf: 'PR', income: '5000' } }
  ...
  it 'should create a client with loan product EMPRESTIMO_PESSOAL and EMPRESTIMO_GARANTIA' do
    ...
    post '/api/v1/clients', params: { client: { name: 'Joao', cpf: '12345678911', birth_date: '1990/03/17', uf: 'sp', income: '3000' } }
  ...
  it 'should create a client with loan product EMPRESTIMO_PESSOAL, EMPRESTIMO_GARANTIA and EMPRESTIMO_CONSIGNADO' do
    LoanProduct.create(loan_type: 'EMPRESTIMO_PESSOAL', interest_rate: 4)
    LoanProduct.create(loan_type: 'EMPRESTIMO_GARANTIA', interest_rate: 3)
    LoanProduct.create(loan_type: 'EMPRESTIMO_CONSIGNADO',  interest_rate: 2)
    
    post '/api/v1/clients', params: { client: { name: 'Joao', cpf: '12345678911', birth_date: '1993/03/17', uf: 'PR', income: '5000' } }
    
    expect(response).to have_http_status(201)
    expect(response.body).to eq("{\"name\":\"Joao\",\"cpf\":\"12345678911\",\"age\":29,\"uf\":\"PR\",\"renda_mensal\":5000.0,\"produto_emprestismo\":[{\"tipo_empretismo\":\"EMPRESTIMO_PESSOAL\",\"taxa_juros\":\"4.0%\"},{\"tipo_empretismo\":\"EMPRESTIMO_GARANTIA\",\"taxa_juros\":\"3.0%\"},{\"tipo_empretismo\":\"EMPRESTIMO_CONSIGNADO\",\"taxa_juros\":\"2.0%\"}]}")
  end
